...
def create_population_table(countries, cur, conn):
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS country_data (country TEXT PRIMARY KEY, population INTEGER, male_life_expectancy INTEGER, female_life_expectancy INTEGER, internet_users INTEGER, gap_expectancies INTEGER)")
    ...
    for country in countries:
        ...
        cur.execute("INSERT OR IGNORE INTO country_data (country,population,male_life_expectancy,female_life_expectancy,internet_users, gap_expectancies) VALUES (?,?,?,?,?,?)",(countries_name,population,male_life_expectancy,female_life_expectancy,internet_users,gap_expectancies))
        conn.commit()
